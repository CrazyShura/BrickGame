...
{
	public static EventHandler<Ball> BallLost = new EventHandler<Ball>();
	public static EventHandler<int> PointsRecived = new EventHandler<int>();
	public static EventHandler GameOver = new EventHandler();
	public static EventHandler LiveLost = new EventHandler();
}
#region Support
